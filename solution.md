> ### Q1. 프론트엔드, 백엔드, DB 아키텍처를 그림(다이어그램) 및 특정 라이브러리나 아키텍쳐의 선택 이유
...
---
> ### Q2. AI 어시스턴트가 생성한 코드를 실제 프로젝트에 반영할 때, 엔지니어로서 가장 중요하게 검증해야 하는 항목은?
...
---
> ### Q3. 제작 중 경험한 AI 의 한계(로직 오류, 설계 결함 등)와, 왜 그런 문제가 발생했다고 판단했는지와 본인의 지시나 수정을 통해 이를 어떻게 해결했는지?
